...
export default function Expertise() {
  ...
  return (
    <section className="bg-dark relative mb-16 md:mb-32">
      <div className="hidden md:flex sticky top-0 h-screen w-full items-center justify-center pointer-events-none z-1 overflow-hidden">
      ...
      <div className="relative z-10 md:-mt-[100vh]">
        {safeItems.map((item, idx) => (
          <motion.div 
            ...
            className="min-h-[100svh] w-full flex items-center justify-center text-center px-4 relative group"
          >
